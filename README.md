# Zach Taylor's Coding Portfolio

Welcome to my coding portfolio! This web application is built using ReactJs with Sass styling, showcasing my skills, projects, and achievements in the field of web development. You can check it out [here!](https://zachtaylor.netlify.app/)

![image](https://github.com/user-attachments/assets/3387bf14-3af1-43b3-9a4f-55536ce4f30b)
## Table of Contents
...
1. Clone the repository: `git clone https://github.com/your-username/your-portfolio.git](https://github.com/ZachTaylor2002/PortfolioWebsite.git`
